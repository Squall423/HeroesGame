        ...
        switch (aEs.getSpellStatistic()) {
            case FIRE_BALL:
                switch (aMasteries.getFire()) {
                    case BASIC:
                        return new SingleTargetDamageSpell(15, SpellsStatistic.TargetType.MAP, aEs.getElement(),
                                aHeroPower * 10 + 15, 3);
                    case ADVANCED:
                        return new SingleTargetDamageSpell(15, SpellsStatistic.TargetType.MAP, aEs.getElement(),
                                aHeroPower * 10 + 30, 3);
            ...
            case IMPLOSION:
                switch (aMasteries.getFire()) {
                    case BASIC:
                        return new SingleTargetDamageSpell(aEs.getManaCost(), SpellsStatistic.TargetType.ENEMY,
                                aEs.getElement(),
                                aHeroPower * 75 + 100, 0);
                    case ADVANCED:
                        return new SingleTargetDamageSpell(aEs.getManaCost(), SpellsStatistic.TargetType.ENEMY,
            ...
            case DEATH_RIPPLE:
                switch (aMasteries.getFire()) {
                    case BASIC:
                        return new SingleTargetDamageSpell(aEs.getManaCost(), SpellsStatistic.TargetType.ALL,
